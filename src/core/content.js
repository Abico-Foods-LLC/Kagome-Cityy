...
/** Иргэд хоорондоо ярилцах богино яриа: [эхлүүлэгч, хариулагч, (эхлүүлэгч)] */
export const CITIZEN_CHAT = [
  ['Сайн уу, найзаа!', 'Сайн, сайн уу!', 'Өнөөдөр гоё өдөр байна шүү.'],
  ['Цаг агаар сайхан байна!', 'Тийм ээ, нар гарлаа!', 'Талбай руу явъя!'],
  ['Загас барив уу?', 'Гурвыг барьсан!', 'Хөөх, гоё!'],
  ['Шүүс уух уу?', 'Лууван-жүржтэй нь хамгийн амттай!', 'Лабораторид очъё.'],
  ['Луувсай хаана байна?', 'Тэнд гүйж явна!', 'Хөөрхөн нохой шүү.'],
  ['Талбай чинь ургав уу?', 'Улаан лооль бэлэн болж байна!', 'Надад ч өгөөрэй!'],
  ['Өчигдөр гүүрэн дээр нугас харсан.', 'Тэд бүгд гоё дуулдаг!', 'Ха-ха, тийм!'],
  ['Алтан лууван олов уу?', 'Хоёрыг олсон, бусад нь нуугдмал.', 'Хамт хайя!'],
  ['Жимсэн машин хурдан юм.', 'Болгоомжтой жолоодох хэрэгтэй!', 'Мэдээж.'],
  ['Өнөөдөр хүргэлт хийсэн үү?', 'Тийм, цагтаа хүргэсэн!', 'Мундаг байна!'],
];

/** Quest NPC-үүд (байрлал, яриа) */
...
/** Дүрүүдийн бусад яриа (нэг газар — TTS clip үүсгэхэд бүгдийг цуглуулна) */
export const LINES = {
  greet: ['Сайн уу!', 'Өдрийн мэнд!', 'Сайхан аялаарай!', 'Хөөе, найзаа!'],
  farmer: ['Ургац сайн байна!', 'Лууван ус хэрэгтэй!', 'Талбай минь…'],
  vendor: ['Шүүс аваарай!', 'Kagome шүүс — амттай!', 'Хямдрал байна!'],
  fisher: ['Чшш… загас ирж байна.', 'Өнөөдөр гурвыг барилаа.', 'Тэвчээр хэрэгтэй!'],
  upset: 'Өө… чи намайг мөргөчихсөн шүү дээ. Өвдлөө…',
  forgive: 'Зүгээр, дараа болгоомжтой байгаарай!',
  carryJoy: 'Хөөх, өндөр юм!',
  thanks: 'Баярлалаа! Чи үнэхээр сайн найз юм!',
  emote: { wave: 'Сайн уу!', cheer: 'Ура!', dance: 'Ла-ла-ла!' },
  voiceTest: 'Сайн уу! Би ярьж чадна!',
  requestDog: 'Луувсайтай уулзмаар байна, дагуулж ирээч!',
  requestFruit: (emoji, name, n) => `${emoji} ${name} ${n} ширхэг олж өгөөч!`,
};

/** Чатын бэлэн үг/emoji */
export const CHAT_PHRASES = ['Сайн уу! 👋', 'Ирээрэй!', 'Хөөх! 😮', 'Баярлалаа 🙏', 'Хамт машинаар явъя 🚗', 'Намайг өргөөч 🙌', 'Буулгаач! 😅', 'Загас барья 🎣', 'Талбай руу 🌱', 'Ширэнгэ рүү 🌴', 'Баяртай 👋', 'Ха-ха 😂'];
